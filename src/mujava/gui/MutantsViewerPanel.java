...
public abstract class MutantsViewerPanel extends JPanel {
    ...
    boolean isProperClass(String str) {
        ...
        switch (getMutantType()) {
            case MutationSystem.CM:
                names[0] = "traditional_mutants";
                break;
            case MutationSystem.TM:
                names[0] = "class_mutants";
                break;
            case MutationSystem.EM:
                names[0] = "exceptional_mutants";
                break;
...
//                                 break;                              
    ...
    void showGeneratedMutantsNum(String[] name) {
        ...
        switch (getMutantType()) {
            case MutationSystem.CM:
                operators = MutationSystem.cm_operators; // Ŭ���� ���� �����̼� ������
                break;
            case MutationSystem.TM:
                operators = MutationSystem.tm_operators; // �޼ҵ� ���� �����̼� ������
                break;
            case MutationSystem.EM:
                operators = MutationSystem.em_operators; // ���ܻ�Ȳ �����̼� ������
                break;
